...
class ConnectionServiceClient extends $grpc.Client {
  static final _$requestUserId =
      $grpc.ClientMethod<Empty, RequestUserIdResponse>(
  ...
  $grpc.ResponseFuture<RequestUserIdResponse> requestUserId(Empty request,
      {$grpc.CallOptions options}) {
...
abstract class ConnectionServiceBase extends $grpc.Service {
  ...
  ConnectionServiceBase() {
    $addMethod($grpc.ServiceMethod<Empty, RequestUserIdResponse>(
        'RequestUserId',
        requestUserId_Pre,
        false,
        false,
